...
export default function Navbar() {
  ...
  return (
    <div className="font-insitutrial relative mb-4 lg:mb-6">
      <div className="flex flex-wrap items-center text-2xs 2xl:text-xl lg:text-base">
        ...
        <div className="flex-1 relative">
          <div className="lg:grid grid-cols-4 text-white items-center bg-pink relative">
            ...
            <button
              onClick={toggleMenu}
              className="bg-pink lg:hidden sticky top-0 flex justify-between lg:mr-10 py-2 md:px-12 px-4 xl:px-12 lg:text-center text-white w-full"
              aria-label="Toggle menu"
            >
              <IoIosMenu className="text-white text-3xl sm:text-4xl md:text-4xl lg:text-6xl" />
            </button>
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-0 lg:gap-8 md:px-12 lg:px-16">
